...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\studentwsb\PycharmProjects\djangoRestApiExample\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\studentwsb\PycharmProjects\djangoRestApiExample\venv\Scripts\deactivate.nu'
